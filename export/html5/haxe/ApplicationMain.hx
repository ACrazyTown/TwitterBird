...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("KillTheTwitterBird-Haxe", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("KillTheTwitterBird-Haxe", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "86";
		app.meta["company"] = "ACrazyTown";
		app.meta["file"] = "KillTheTwitterBird-Haxe";
		app.meta["name"] = "Kill The Twitter Bird";
